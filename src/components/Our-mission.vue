...
<template>
  <section class="bg-slate-600 py-16 px-6 sm:px-12 lg:px-24 min-h-screen flex flex-col justify-center">
    ...
    <div class="grid grid-cols-1 gap-8 sm:gap-12">
      <div class="animate-on-scroll slide-in-left bg-white p-8 rounded-lg shadow-lg transform transition duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-brandOrange">
      ...
      <div class="animate-on-scroll slide-in-right bg-white p-8 rounded-lg shadow-lg transform transition duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-brandOrange">
